...
api_key <- # ADD API KEY HERE -- do not make public
...
outrast <- texture_image(elev, window_type = 'square', size = 7, in_meters = FALSE, epsg_proj = 5070, metric = 'sa', args = list(low = 0, high = 0.05)) 
```
...
write.csv(sa_data_elev, 'sa_elevation.csv', row.names = F)
```
