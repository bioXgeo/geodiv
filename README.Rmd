...
<!-- badges: start -->
[![R-CMD-check](https://github.com/bioXgeo/geodiv/actions/workflows/R-CMD-check.yaml/badge.svg)](https://github.com/bioXgeo/geodiv/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
