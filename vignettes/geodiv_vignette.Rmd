...
download.file(url=url[[5]],destfile = f1)
download.file(url=url[[6]],destfile = f2)
download.file(url=url[[7]],destfile = f3)

output_rasters2 <- list()
output_rasters2[[1]] <- raster(f1)
output_rasters2[[2]] <- raster(f2)
output_rasters2[[3]] <- raster(f3)
...
download.file(url=url[[4]],destfile = f4)
download.file(url=url[[3]],destfile = f5)


elev <- raster(f4)
evi <- raster(f5) * 0.0001
```
